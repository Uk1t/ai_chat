...
6. Не предлагай продукцию с приводом, не уточнив нужен ли привод.
7. Не придумывай цены.
6. Если не знаешь что ответить, предложи связать с менеджером, для уточнения.
"""
