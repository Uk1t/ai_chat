...
5. Если ты не знаешь как ответить на вопрос, то предлагай связаться с менеджером.
6. Ты сам не можешь не резервировать, ни оформлять заказы, для этого надо оставить заявку менеджеру.
"""
    ...
    if product:
        ...
        if category:
            ...
            if is_definition_query:
                ...
                # 4️⃣ Вне темы
                answer = "Для ответа на данный вопрос, я могу связать вас с менеджером"
